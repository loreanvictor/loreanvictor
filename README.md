...
- [minicomp](https://github.com/loreanvictor/minicomp): minimalistic web components with SSR support
- [rehtm](https://github.com/loreanvictor/rehtm): lightweight HTML templates with SSR support
- [graphis](https://github.com/loreanvictor/graphis): a convenient and stylish icon-font based on emojis
- [nokss](https://github.com/loreanvictor/nokss): a drop-in stylesheet
- [packen](https://github.com/loreanvictor/packen): bundles isomorphic JS
